...
const startAnimationLoop = ({ onProgress, onComplete, duration, initialProgress }) => {
    let start = null;
    let requestId = null;
...
/* custom animations */
const slide = (element, { duration, direction, onComplete }) => {
...
const slideDown = (element, { duration = 750, onComplete } = {}) => {
    return slide(element, { direction: 'DOWN', duration, onComplete });
}

const slideUp = (element, { duration = 750, onComplete } = {}) => {
